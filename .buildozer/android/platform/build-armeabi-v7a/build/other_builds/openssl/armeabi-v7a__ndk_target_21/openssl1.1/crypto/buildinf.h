...
#define DATE "built on: Tue Apr 20 02:33:16 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','j','o','s','h',
    '/','P','y','c','h','a','r','m','P','r','o','j','e','c','t','s',
    '/','w','a','t','c','h','b','a','n','d','/','.','b','u','i','l',
